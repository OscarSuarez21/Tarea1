...
public class Ejecutar {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("nombre del hijo de "+ mama.getNombres()+" es: "+ mama.getHijoP().getNombres());
        System.out.println("nombre del hijo de "+ papa.getNombres()+" es: "+ papa.getHijoP().getNombres());
        System.out.println("nombre de la hija de "+ mama.getNombres()+" es: "+ mama.getHijoS().getNombres());
